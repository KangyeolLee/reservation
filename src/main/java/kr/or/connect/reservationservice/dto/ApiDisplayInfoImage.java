...
public class ApiDisplayInfoImage {
	private int id;
	...
	public String toString() {
		return "ApiDisplayInfoImage [id=" + id + ", fileName=" + fileName + ", saveFileName=" + saveFileName
				+ ", contentType=" + contentType + ", deleteFlag=" + deleteFlag + ", createDate=" + createDate
				+ ", modifyDate=" + modifyDate + ", displayInfoImageId=" + displayInfoImageId + ", displayInfoId="
				+ displayInfoId + "]";
	}
